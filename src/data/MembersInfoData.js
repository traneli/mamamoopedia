export const MembersInfo = [
    {
      ...
      'Rapper & Performance\\n' +
      'Colors: Yellow (Moosical) / Red (4season)',
      description: 
      ...
      socials: [
        {
          name: 'spotify',
          url: 'https://open.spotify.com/artist/1eTft3tXynrKdo6XD7QHLL'
        },
        {
          name: 'instagram',
    ...
    },
    {
      ...
      'Leader & Vocal \\n' +
      'Colors: Green (Moosical) / Blue (4season)',
      description: 
      ...
      socials: [
        {
          name: 'spotify',
          url: 'https://open.spotify.com/artist/5cYcI546S8Lf97m4mNdYLD'
        },
        {
          name: 'instagram',
          url: 'https://www.instagram.com/solarkeem/'
        },
        {
          name: 'youtube',
          url: 'https://www.youtube.com/channel/UCNx0TXIuGVEA_TWB5H2I6Lg'
        }
      ]
    },
    {
      ...
      'Vocal & Performance\\n' +
      'Colors: Orange (Moosical) / White (4season)',
      description: 
      '彡 Has a Scottish Fold named Ggomo\\n' +
      '彡 Has 11 tattoos, 2 of which are friendship tattoos with Hwasa\\n' +
      '彡 Appeared on \'Secret Unnie\' with SNSD\'s Hyoyeon\\n' +
      ...
      socials: [
        {
          name: 'spotify',
          url: 'https://open.spotify.com/artist/0BqRGrwqndrtNkojXiqIzL'
        },
        {
          name: 'instagram',
          url: 'https://www.instagram.com/whee_inthemood/'
        }
      ]
    },
    {
      ...
      socials: [
        {
          name: 'spotify',
          url: 'https://open.spotify.com/artist/7bmYpVgQub656uNTu6qGNQ'
        },
        {
          name: 'instagram',
